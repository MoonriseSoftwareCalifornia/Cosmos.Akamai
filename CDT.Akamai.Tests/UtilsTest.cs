...
namespace CDT.Akamai.Tests
{
    ...
    public class UtilsTest
    {
        ...
        public void ComputeHashHexTest()
        {
            ...
            Assert.AreEqual(new MemoryStream(data).ComputeHash().ToHex().ToLower(),
        ...
        public void ComputeHashBase64Test()
        {
            ...
            Assert.AreEqual(new MemoryStream(data).ComputeHash().ToBase64(),
        ...
        {
            "value".ToByteArray().ComputeKeyedHash(null);
        }
        ...
        public void ComputeKeyedHashTest()
        {
            ...
            Assert.AreEqual(data.ComputeKeyedHash(key).ToBase64(),
        ...
        public void ReadExactlyTest()
        {
            ...
            {
                Assert.AreEqual(Encoding.UTF8.GetString(stream.ReadExactly(50)),
                    "Lorem ipsum dolor sit amet, an sea putant quaeque,");
            }
        }
    }
}